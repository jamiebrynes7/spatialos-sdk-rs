...
pub fn main() {
    ...
    let mut input_file = File::open(input_filename).expect("Unable to open the test schema bundle.");
    let mut contents = String::new();
    input_file.read_to_string(&mut contents).expect("Unable to read the test schema bundle");
