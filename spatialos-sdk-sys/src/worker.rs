...
pub const WORKER_API_VERSION_MINOR: u32 = 1;
pub const WORKER_API_VERSION_PATCH: u32 = 0;
pub const WORKER_API_VERSION: u32 = 917760;
pub const WORKER_API_VERSION_STR: &'static [u8; 7usize] = b"14.1.0\0";
...
pub struct Worker_Alpha_KcpParameters {
    ...
    #[doc = " Number of multiplexed KCP streams."]
    pub multiplex_level: u32,
    #[doc = " The maximum interval, in milliseconds, between which the KCP transport layer sends packets"]
    #[doc = " waiting in its cross-stream send buffer. The transport layer may send earlier if there are"]
    #[doc = " enough packets to fill the MTU or if there has been a call to flush the network."]
    pub update_interval_millis: u32,
    #[doc = " Hard limit on the minimum retransmission timeout. A packet will be resent if an"]
    #[doc = " acknowledgment has not been received from the peer within a time period known as the"]
    #[doc = " retransmission timeout. The retransmission timeout is calculated based on estimated round"]
...
#[doc = " Parameters for configuring compression. Used by Worker_Alpha_ModularUdpNetworkParameters."]
#[doc = " Currently, there are no configurable settings; if this struct is not NULL compression is enabled."]
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct Worker_Alpha_CompressionParameters {
...
pub struct Worker_Alpha_ModularUdpNetworkParameters {
    ...
    pub downstream_compression: *const Worker_Alpha_CompressionParameters,
    #[doc = " Compression parameters for messages sent from the worker to the bridge."]
    pub upstream_compression: *const Worker_Alpha_CompressionParameters,
...
extern "C" {
    ...
    #[doc = " This currently only has an effect if using the Worker_Alpha_ModularUdpNetworkParameters."]
...
extern "C" {
    ...
    #[doc = " to check whether any error occurred during operation."]
