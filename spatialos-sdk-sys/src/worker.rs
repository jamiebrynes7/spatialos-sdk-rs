...
pub const WORKER_DEFAULTS_MODULAR_TCP_MULTIPLEX_LEVEL: u32 = 1;
...
pub const WORKER_DEFAULTS_KCP_DISABLE_CONGESTION_CONTROL: u32 = 1;
pub const WORKER_DEFAULTS_KCP_MULTIPLEX_LEVEL: u32 = 1;
pub const WORKER_DEFAULTS_KCP_UPDATE_INTERVAL_MILLIS: u32 = 10;
pub const WORKER_DEFAULTS_KCP_FLUSH_INTERVAL_MILLIS: u32 = 1;
...
pub type Schema_ComponentId = u32;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Schema_Json {
    _unused: [u8; 0],
}
#[doc = " Configuration parameters for JSON serialization."]
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct Schema_JsonParameters {
    #[doc = " If enabled, JSON will be printed with indentation for better readability."]
    pub enable_pretty_printing: u8,
}
#[doc = " An error callback, used to signal one or more error messages (separated by \"\\n\") for debugging."]
...
extern "C" {
    #[doc = " Allocate a generic data object (i.e. arbitrary schema object) type instance."]
    pub fn Schema_CreateGenericData() -> *mut Schema_GenericData;
}
extern "C" {
    #[doc = " Performs a deep copy of the source generic data object and returns the new copy."]
    pub fn Schema_CopyGenericData(source: *const Schema_GenericData) -> *mut Schema_GenericData;
}
extern "C" {
    #[doc = " Free the resources associated with a generic data object type instance."]
    pub fn Schema_DestroyGenericData(request: *mut Schema_GenericData);
}
extern "C" {
    #[doc = " Get the generic data object as a Schema_Object."]
    pub fn Schema_GetGenericDataObject(request: *mut Schema_GenericData) -> *mut Schema_Object;
}
extern "C" {
...
extern "C" {
    #[doc = " Get the component data snapshot as a Schema_Object."]
...
extern "C" {
    ...
    pub fn Schema_ConvertComponentDataIntoUpdate(
        ...
        component_id: Schema_ComponentId,
...
extern "C" {
    ...
    #[doc = " other object. The memory is freed by a call to the Schema_DestroyX function associated with the"]
    #[doc = " parent object."]
...
extern "C" {
    ...
    #[doc = " instance. The memory is freed by a call to the Schema_DestroyX function associated with the"]
    #[doc = " parent object."]
    #[doc = ""]
...
extern "C" {
    #[doc = " Free the resources associated with a Schema_Json instance."]
    pub fn Schema_Json_Destroy(json: *mut Schema_Json);
}
extern "C" {
    #[doc = " Get a null-terminated JSON string from a Schema_Json instance."]
    #[doc = ""]
    #[doc = " The returned pointer will be valid until the source Schema_Json object is destroyed with"]
    #[doc = " Schema_Json_Destroy."]
    pub fn Schema_Json_GetJsonString(json: *const Schema_Json) -> *const ::std::os::raw::c_char;
}
extern "C" {
    #[doc = " Get a null-terminated string containing the last set of errors that occurred while performing"]
    #[doc = " JSON operations. If multiple errors occur, they will be separated by a newline (\\n)."]
    #[doc = " Returns NULL if no error occurred."]
    #[doc = ""]
    #[doc = " The returned pointer will remain valid until another Schema_Json_* function (with the exception"]
    #[doc = " Schema_Json_GetLastWarning) is called from the same thread."]
    pub fn Schema_Json_GetLastError() -> *const ::std::os::raw::c_char;
}
extern "C" {
    #[doc = " Get a null-terminated string containing the last warning that occurred while performing JSON"]
    #[doc = " operations. If multiple warnings occur, they will be separated by a newline (\\n)."]
    #[doc = " Returns NULL if no warning occurred."]
    #[doc = ""]
    #[doc = " The returned pointer will remain valid until another Schema_Json_* function (with the exception"]
    #[doc = " Schema_Json_GetLastError) is called from the same thread."]
    pub fn Schema_Json_GetLastWarning() -> *const ::std::os::raw::c_char;
}
extern "C" {
    #[doc = " Loads a Schema_Object from the provided null-terminated JSON string given the provided schema"]
    #[doc = " bundle and qualified type name."]
    #[doc = ""]
    #[doc = " Returns 1 if no error occurred."]
    #[doc = " Returns 0 if there was a failure to read any data from the JSON; use Schema_Json_GetLastError"]
    #[doc = " to get a string description of the error that occurred."]
    #[doc = ""]
    #[doc = " Note: Warnings may also be generated in some cases. Use Schema_Json_GetLastWarning to get a"]
    #[doc = " string description of any warning that occurred during this operation."]
    pub fn Schema_Json_LoadObject(
        bundle: *const Schema_Bundle,
        qualified_type_name: *const ::std::os::raw::c_char,
        json_string: *const ::std::os::raw::c_char,
        object: *mut Schema_Object,
    ) -> u8;
}
extern "C" {
    #[doc = " Dumps the given Schema_Object instance into a Schema_Json using the provided bundle and"]
    #[doc = " qualified type name."]
    #[doc = ""]
    #[doc = " It is the caller's responsibility to free the returned Schema_Json* by calling"]
    #[doc = " Schema_Json_Destroy."]
    #[doc = ""]
    #[doc = " Note: Returns NULL if an error occurred. Use Schema_Json_GetLastError to get a string"]
    #[doc = " description of the error that occurred during this operation."]
    #[doc = ""]
    #[doc = " Note: Warnings may also be generated in some cases. Use Schema_Json_GetLastWarning to get a"]
    #[doc = " string description of any warning that occurred during this operation."]
    pub fn Schema_Json_DumpObject(
        bundle: *const Schema_Bundle,
        qualified_type_name: *const ::std::os::raw::c_char,
        object: *mut Schema_Object,
    ) -> *mut Schema_Json;
...
extern "C" {
    #[doc = " Loads a Schema_ComponentData from the provided JSON string given the provided schema bundle and"]
    #[doc = " component ID."]
    #[doc = ""]
    #[doc = " It is the caller's responsibility to free the returned Schema_ComponentData* by calling"]
    #[doc = " Schema_DestroyComponentData."]
    #[doc = ""]
    #[doc = " Note: Returns NULL if an error occurred. Use Schema_Json_GetLastError to get a string"]
    #[doc = " description of the error that occurred during this operation."]
    #[doc = ""]
    #[doc = " Note: Warnings may also be generated in some cases. Use Schema_Json_GetLastWarning to get a"]
    #[doc = " string description of any warning that occurred during this operation."]
    pub fn Schema_Json_LoadComponentData(
        bundle: *const Schema_Bundle,
        component_id: Schema_ComponentId,
        json_string: *const ::std::os::raw::c_char,
    ) -> *mut Schema_ComponentData;
...
extern "C" {
    #[doc = " Dumps the given Schema_ComponentData instance into a Schema_Json using the provided"]
    #[doc = " bundle and component ID."]
    #[doc = ""]
    #[doc = " It is the caller's responsibility to free the returned Schema_Json* by calling"]
    #[doc = " Schema_Json_Destroy."]
    #[doc = ""]
    ...
    #[doc = " Note: Warnings may also be generated in some cases. Use Schema_Json_GetLastWarning to get a"]
    #[doc = " string description of any warning that occurred during this operation."]
    pub fn Schema_Json_DumpComponentData(
        bundle: *const Schema_Bundle,
        component_id: Schema_ComponentId,
        data: *mut Schema_ComponentData,
    ) -> *mut Schema_Json;
...
extern "C" {
    #[doc = " Loads a Schema_ComponentUpdate from the provided JSON string given the provided schema bundle and"]
    #[doc = " component ID."]
    #[doc = ""]
    #[doc = " It is the caller's responsibility to free the returned Schema_ComponentUpdate* by calling"]
    #[doc = " Schema_DestroyComponentUpdate."]
    #[doc = ""]
    #[doc = " Note: Returns NULL if an error occurred. Use Schema_Json_GetLastError to get a string"]
    #[doc = " description of the error that occurred during this operation."]
    #[doc = ""]
    #[doc = " Note: Warnings may also be generated in some cases. Use Schema_Json_GetLastWarning to get a"]
    #[doc = " string description of any warning that occurred during this operation."]
    pub fn Schema_Json_LoadComponentUpdate(
        bundle: *const Schema_Bundle,
        component_id: Schema_ComponentId,
        json_string: *const ::std::os::raw::c_char,
    ) -> *mut Schema_ComponentUpdate;
...
extern "C" {
    #[doc = " Dumps the given Schema_ComponentUpdate instance into a Schema_Json using the provided"]
    #[doc = " bundle and component ID."]
    #[doc = ""]
    #[doc = " It is the caller's responsibility to free the returned Schema_Json* by calling"]
    #[doc = " Schema_Json_Destroy."]
    ...
    #[doc = " Note: Warnings may also be generated in some cases. Use Schema_Json_GetLastWarning to get a"]
    #[doc = " string description of any warning that occurred during this operation."]
    pub fn Schema_Json_DumpComponentUpdate(
        bundle: *const Schema_Bundle,
        component_id: Schema_ComponentId,
        update: *mut Schema_ComponentUpdate,
    ) -> *mut Schema_Json;
...
extern "C" {
    #[doc = " Loads a Schema_CommandRequest from the provided JSON string given the provided schema bundle and"]
    #[doc = " component ID."]
    #[doc = ""]
    #[doc = " It is the caller's responsibility to free the returned Schema_CommandRequest* by calling"]
    #[doc = " Schema_DestroyCommandRequest."]
    #[doc = ""]
    #[doc = " Note: Returns NULL if an error occurred. Use Schema_Json_GetLastError to get a string"]
    #[doc = " description of the error that occurred during this operation."]
    #[doc = ""]
    #[doc = " Note: Warnings may also be generated in some cases. Use Schema_Json_GetLastWarning to get a"]
    #[doc = " string description of any warning that occurred during this operation."]
    pub fn Schema_Json_LoadCommandRequest(
        bundle: *const Schema_Bundle,
        component_id: Schema_ComponentId,
...
extern "C" {
    #[doc = " Dumps the given Schema_CommandRequest instance into a Schema_Json using the provided schema"]
    #[doc = " bundle, component ID and command index."]
    #[doc = ""]
    #[doc = " It is the caller's responsibility to free the returned Schema_Json* by calling"]
    #[doc = " Schema_Json_Destroy."]
    #[doc = ""]
    ...
    #[doc = " Note: Warnings may also be generated in some cases. Use Schema_Json_GetLastWarning to get a"]
    #[doc = " string description of any warning that occurred during this operation."]
    pub fn Schema_Json_DumpCommandRequest(
        bundle: *const Schema_Bundle,
        component_id: Schema_ComponentId,
        command_index: Schema_FieldId,
        request: *mut Schema_CommandRequest,
...
extern "C" {
    #[doc = " Loads a Schema_CommandResponse from the provided JSON string given the provided bundle, component"]
    #[doc = " ID, and command index."]
    #[doc = ""]
    #[doc = " It is the caller's responsibility to free the returned Schema_CommandResponse* by calling"]
    #[doc = " Schema_DestroyCommandResponse."]
    #[doc = ""]
    #[doc = " Note: Returns NULL if an error occurred. Use Schema_Json_GetLastError to get a string"]
    #[doc = " description of the error that occurred during this operation."]
    #[doc = ""]
    #[doc = " Note: Warnings may also be generated in some cases. Use Schema_Json_GetLastWarning to get a"]
    #[doc = " string description of any warning that occurred during this operation."]
    pub fn Schema_Json_LoadCommandResponse(
        bundle: *const Schema_Bundle,
        component_id: Schema_ComponentId,
        command_index: Schema_FieldId,
        json_string: *const ::std::os::raw::c_char,
...
extern "C" {
    #[doc = " Dumps the given Schema_CommandResponse instance into a Schema_Json using the provided"]
    #[doc = " schema bundle, component ID and command index."]
    #[doc = ""]
    #[doc = " It is the caller's responsibility to free the returned Schema_Json* by calling"]
    #[doc = " Schema_Json_Destroy."]
    #[doc = ""]
    ...
    #[doc = " Note: Warnings may also be generated in some cases. Use Schema_Json_GetLastWarning to get a"]
    #[doc = " string description of any warning that occurred during this operation."]
    pub fn Schema_Json_DumpCommandResponse(
        bundle: *const Schema_Bundle,
        component_id: Schema_ComponentId,
        command_index: Schema_FieldId,
        response: *mut Schema_CommandResponse,
...
#[doc = " SDK."]
pub type Worker_LogLevel = ::std::os::raw::c_int;
pub const Worker_LogCategory_WORKER_LOG_CATEGORY_RECEIVE: Worker_LogCategory = 1;
pub const Worker_LogCategory_WORKER_LOG_CATEGORY_SEND: Worker_LogCategory = 2;
pub const Worker_LogCategory_WORKER_LOG_CATEGORY_NETWORK_STATUS: Worker_LogCategory = 4;
...
#[doc = " Log messages are logged into a set of rotating files with a specific maximum size."]
pub const Worker_LogsinkType_WORKER_LOGSINK_TYPE_ROTATING_FILE: Worker_LogsinkType = 1;
#[doc = " For each received log message a user callback is called."]
pub const Worker_LogsinkType_WORKER_LOGSINK_TYPE_CALLBACK: Worker_LogsinkType = 2;
#[doc = " Log messages are sent to stdout."]
pub const Worker_LogsinkType_WORKER_LOGSINK_TYPE_STDOUT: Worker_LogsinkType = 3;
#[doc = " Log messages are sent to stdout and are ANSI color coded."]
pub const Worker_LogsinkType_WORKER_LOGSINK_TYPE_STDOUT_ANSI: Worker_LogsinkType = 4;
#[doc = " Log messages are sent to stderr."]
pub const Worker_LogsinkType_WORKER_LOGSINK_TYPE_STDERR: Worker_LogsinkType = 5;
#[doc = " Log messages are sent to stderr and are ANSI color coded."]
pub const Worker_LogsinkType_WORKER_LOGSINK_TYPE_STDERR_ANSI: Worker_LogsinkType = 6;
#[doc = " Enum defining the types of logsinks that can receive log messages from the the SDK."]
pub type Worker_LogsinkType = ::std::os::raw::c_int;
...
pub type Worker_StatusCode = ::std::os::raw::c_int;
...
pub type Worker_ConnectionStatusCode = ::std::os::raw::c_int;
...
#[doc = " The component update will not be returned in a subsequent call to Worker_GetOpList."]
pub const Worker_ComponentUpdateLoopback_WORKER_COMPONENT_UPDATE_LOOPBACK_NONE:
    Worker_ComponentUpdateLoopback = 0;
#[doc = " The component update will also be returned in a subsequent call to Worker_GetOpList."]
...
pub type Worker_ComponentUpdateLoopback = ::std::os::raw::c_int;
...
pub type Worker_ConstraintType = ::std::os::raw::c_int;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
...
pub type Worker_ResultType = ::std::os::raw::c_int;
#[doc = " An entity query."]
#[repr(C)]
#[derive(Copy, Clone)]
...
pub type Worker_OpType = ::std::os::raw::c_int;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub const Worker_NetworkSecurityType_WORKER_NETWORK_SECURITY_TYPE_TLS: Worker_NetworkSecurityType =
    1;
#[doc = " An alias for WORKER_NETWORK_SECURITY_TYPE_TLS."]
...
pub type Worker_NetworkSecurityType = ::std::os::raw::c_int;
#[doc = " Parameters for configuring a RakNet connection. Used by Worker_NetworkParameters."]
#[doc = " DEPRECATED: The RakNet stack has been deprecated and will be removed in a future version of"]
#[doc = " SpatialOS."]
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
...
pub struct Worker_TcpNetworkParameters {
    #[doc = " The number of multiplexed TCP connections to use. Updates for entities are sharded across"]
    #[doc = " connections: the higher the multiplex level, the fewer entities might be impacted by a delayed"]
    #[doc = " update. Messages across connections cannot be packed into the same TCP packet, which may result"]
    #[doc = " in higher bandwidth usage. Increasing the number of multiplexed streams may also increase CPU"]
    #[doc = " usage."]
...
#[doc = " Parameters to configure flow control. Used by Worker_ModularKcpNetworkParameters and"]
#[doc = " Worker_ModularTcpNetworkParameters."]
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct Worker_FlowControlParameters {
...
#[doc = " DEPRECATED: This KCP stack has been deprecated and will be removed in a future version of"]
#[doc = " SpatialOS. To use KCP, use Worker_ModularKcpNetworkParameters instead."]
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct Worker_KcpNetworkParameters {
    ...
    #[doc = " the multiplex level, the fewer entities might be impacted by a delayed update. Messages across"]
    #[doc = " streams cannot be packed into the same UDP packet which may result in higher bandwidth usage."]
    #[doc = " Increasing the number of multiplexed streams may also increase CPU usage."]
...
#[doc = " Parameters for configuring the KCP transport layer within the modular KCP network stack. Used by"]
#[doc = " Worker_ModularKcpNetworkParameters."]
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct Worker_KcpTransportParameters {
    #[doc = " The maximum interval, in milliseconds, between which the KCP transport layer flushes packets"]
    #[doc = " waiting in its cross-stream send buffer to the network. The transport layer may send earlier"]
    #[doc = " if there are enough packets to fill the MTU or if there has been a call to flush the network."]
    ...
    #[doc = " waiting until the retransmission timeout has expired."]
    pub early_retransmission: u8,
    #[doc = " Whether to disable congestion control which disables the usage of congestion windows (which"]
    #[doc = " are used to reduce packet loss across congested networks). Disabling congestion control can"]
    #[doc = " optimize for low-latency delivery of small messages."]
    pub disable_congestion_control: u8,
    #[doc = " Hard limit on the minimum retransmission timeout. A packet will be resent if an"]
    #[doc = " acknowledgment has not been received from the peer within a time period known as the"]
    #[doc = " retransmission timeout. The retransmission timeout is calculated based on estimated round"]
    #[doc = " trip times to the remote peer, but it will never be set to a value lower than the minimum"]
    ...
    #[doc = " retransmissions rather than optimizing for latency."]
    #[doc = " Set to zero to use default, which is lower when"]
    #[doc = " Worker_KcpTransportParameters::fast_retransmission is enabled."]
    pub min_rto_millis: u32,
}
#[doc = " Parameters for configuring the TCP transport layer within the modular TCP network stack. Used by"]
#[doc = " Worker_ModularTcpNetworkParameters."]
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct Worker_TcpTransportParameters {
    #[doc = " Maximum delay after which to flush data to the network. If non-zero, data may be delayed for up"]
    #[doc = " to this many milliseconds in order to pack more data into network packets and save"]
    #[doc = " bandwidth. If set to zero, data will always be sent immediately without delay. This will"]
    #[doc = " prevent manual flushes from having any effect, and may render compression ineffective."]
    pub flush_delay_millis: u32,
}
#[doc = " Parameters for configuring compression. Used by Worker_ModularKcpNetworkParameters and"]
#[doc = " Worker_ModularTcpNetworkParameters. Currently, there are no configurable settings; if this struct"]
#[doc = " is not NULL compression is enabled."]
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct Worker_CompressionParameters {
    #[doc = " A placeholder field. This is ignored."]
    pub place_holder: ::std::os::raw::c_char,
}
#[doc = " Parameters for configuring the stack for a modular KCP connection. Used by"]
#[doc = " Worker_NetworkParameters."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Worker_ModularKcpNetworkParameters {
    #[doc = " Type of encryption layer security to use, defined in Worker_NetworkSecurityType."]
    pub security_type: u8,
    #[doc = " Number of multiplexed KCP streams. Updates for entities are sharded across streams: the higher"]
...
impl Default for Worker_ModularKcpNetworkParameters {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[doc = " Parameters for configuring the stack for a modular TCP connection. Used by"]
#[doc = " Worker_NetworkParameters."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Worker_ModularTcpNetworkParameters {
    #[doc = " Type of encryption layer security to use, defined in Worker_NetworkSecurityType."]
    pub security_type: u8,
    #[doc = " The number of multiplexed TCP connections to use. Updates for entities are sharded across"]
    #[doc = " connections: the higher the multiplex level, the fewer entities might be impacted by a delayed"]
    ...
    #[doc = " usage."]
    pub multiplex_level: u8,
    #[doc = " TCP parameters for messages sent from the bridge to the worker."]
    pub downstream_tcp: Worker_TcpTransportParameters,
    #[doc = " TCP parameters for messages sent from the worker to the bridge."]
    pub upstream_tcp: Worker_TcpTransportParameters,
    #[doc = " Heartbeat parameters for heartbeats from the bridge to the worker."]
    pub downstream_heartbeat: *const Worker_HeartbeatParameters,
    #[doc = " Heartbeat parameters for heartbeats from the worker to the bridge."]
    pub upstream_heartbeat: *const Worker_HeartbeatParameters,
...
impl Default for Worker_ModularTcpNetworkParameters {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
pub const Worker_NetworkConnectionType_WORKER_NETWORK_CONNECTION_TYPE_MODULAR_KCP:
...
#[doc = " network stack with additional optional features such as compression."]
pub const Worker_NetworkConnectionType_WORKER_NETWORK_CONNECTION_TYPE_MODULAR_TCP:
    Worker_NetworkConnectionType = 4;
#[doc = " Network connection type used by Worker_NetworkParameters."]
pub type Worker_NetworkConnectionType = ::std::os::raw::c_int;
...
pub struct Worker_NetworkParameters {
    ...
    pub modular_kcp: Worker_ModularKcpNetworkParameters,
...
#[doc = " (Deprecated) Tuning parameters for configuring protocol logging in the SDK. Used by"]
...
#[doc = " Parameters for configuring the rotating log files used for a logsink."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Worker_RotatingLogFileParameters {
    #[doc = " Log file names are prefixed with this prefix, are numbered, and have the extension .log."]
    pub log_prefix: *const ::std::os::raw::c_char,
    #[doc = " Maximum number of log files to keep. Note that logs from any previous protocol logging"]
...
#[doc = " Custom callback for filtering log messages. Return true if a message with the given categories"]
#[doc = " and level should be logged."]
pub type Worker_LogFilterCallback = ::std::option::Option<
    unsafe extern "C" fn(
        user_data: *mut ::std::os::raw::c_void,
        categories: u32,
...
>;
#[doc = " Parameters for configuring a custom filter predicate"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Worker_LogFilterParameters {
    #[doc = " Combination of Worker_LogCategory flags defining the messages that should be received. If a"]
    #[doc = " message has at least one of these flags, it is logged to the sink."]
    pub categories: u32,
    #[doc = " All messages of log level >= level are received; defined in Worker_LogLevel enumeration"]
    pub level: u8,
    #[doc = " If set, all log messages are sent through this filter function and ignore the categories"]
    #[doc = " and level members above. Note that this callback will be called concurrently from different"]
    #[doc = " threads. You need to synchronize access to data that is shared with the thread this callback"]
    #[doc = " was set on."]
    pub callback: Worker_LogFilterCallback,
    #[doc = " Pointer to user-defined data that is passed to each callback invocation"]
    pub user_data: *mut ::std::os::raw::c_void,
}
impl Default for Worker_LogFilterParameters {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[doc = " Represents a log message to be consumed by a user-defined callback."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Worker_LogData {
    #[doc = " Date & time when this message was generated."]
    pub timestamp: *const ::std::os::raw::c_char,
    #[doc = " The log categories that this message was generated with."]
    pub categories: u32,
    #[doc = " The log level of this message."]
    pub log_level: u8,
    #[doc = " The message content."]
    pub content: *const ::std::os::raw::c_char,
}
impl Default for Worker_LogData {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[doc = " Custom callback for receiving log messages. Will be called for all log messages that pass through"]
#[doc = " the filter."]
pub type Worker_LogCallback = ::std::option::Option<
    unsafe extern "C" fn(user_data: *mut ::std::os::raw::c_void, message: *const Worker_LogData),
>;
#[doc = " Parameters for configuring a log callback"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Worker_LogCallbackParameters {
    #[doc = " Pointer to callback function that receives new log messages"]
    pub log_callback: Worker_LogCallback,
    #[doc = " Pointer to user-defined data that will be passed to each callback invocation"]
    pub user_data: *mut ::std::os::raw::c_void,
}
impl Default for Worker_LogCallbackParameters {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[doc = " Parameters for configuring a logsink in the SDK."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Worker_LogsinkParameters {
    #[doc = " The type of logsink to use. Depending on this value, a subset of other members is used."]
    #[doc = " Defined in Worker_LogsinkType enumeration."]
    pub logsink_type: u8,
    #[doc = " Parameters for controlling filtering of log messages."]
    pub filter_parameters: Worker_LogFilterParameters,
    #[doc = " Parameters for a rotating log file sink. Only used if logsink_type =="]
    #[doc = " WORKER_LOGSINK_TYPE_ROTATING_FILE."]
    pub rotating_logfile_parameters: Worker_RotatingLogFileParameters,
    #[doc = " Parameters for custom log callback. Only used if logsink_type == WORKER_LOGSINK_TYPE_CALLBACK."]
    #[doc = " Note that this callback will be called from different threads. You need to synchronize access"]
    #[doc = " to data that is shared with the thread this callback was set on. However, the logger guarantees"]
    #[doc = " that only a single log callback is run at a time per connection which can sometimes eliminate"]
    #[doc = " the need for synchronization."]
    pub log_callback_parameters: Worker_LogCallbackParameters,
}
impl Default for Worker_LogsinkParameters {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
pub type Worker_LocatorCredentialsTypes = ::std::os::raw::c_int;
...
pub struct Worker_LocatorParameters {
    ...
    #[doc = " (Deprecated) Parameters for configuring legacy protocol logging."]
    pub logging: Worker_ProtocolLoggingParameters,
    #[doc = " (Deprecated) Whether to enable legacy protocol logging for the Locator flow."]
    pub enable_logging: u8,
    #[doc = " Number of logsinks configured."]
    pub logsink_count: u32,
    #[doc = " Array of logsinks that receive filtered log messages from the SDK. These are enabled by"]
    #[doc = " default."]
    pub logsinks: *const Worker_LogsinkParameters,
}
...
extern "C" {
    #[doc = " Indicates to the network layer that all previous invocations of the Worker_Connection_Send*"]
    #[doc = " methods should be flushed to the network as soon as possible. A common usage pattern is to call"]
    #[doc = " this function after all state changes have been applied at the end of a frame."]
    #[doc = ""]
    #[doc = " This method is asynchronous. In particular, calling is an indication that a flush is wanted, and"]
    #[doc = " can return before messages are fully serialized and put on the network."]
    #[doc = " This currently only has an effect if using the Worker_ModularKcpNetworkParameters or"]
    #[doc = " Worker_ModularTcpNetworkParameters."]
    pub fn Worker_Connection_Alpha_Flush(connection: *mut Worker_Connection);
}
extern "C" {
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " Note: We do not recommend reserving entity IDs. Instead, we recommend using"]
    #[doc = " Worker_SendCreateEntityRequest without specifying an entity ID. You can then use the"]
    #[doc = " automatically assigned entity ID provided in Worker_CreateEntityResponseOp."]
...
extern "C" {
    ...
    #[doc = " component_update->schema_type is set to NULL. If component_update->user_handle is set, then it"]
...
extern "C" {
    #[doc = " (Deprecated) Enables or disables legacy protocol logging. Logging uses the parameters specified"]
    #[doc = " when the connection was created. Enabling it when already enabled, or disabling it when already"]
    #[doc = " disabled, does nothing."]
    #[doc = ""]
    #[doc = " Note that logs from any previous protocol logging sessions will be overwritten."]
    #[doc = ""]
    #[doc = " Either use this or the array of logsinks in Worker_ConnectionParameters. If you call this to"]
    #[doc = " disable protocol logging while other logsinks are enabled, those will be disabled as well."]
...
extern "C" {
    #[doc = " Reenables all logging. If logging was already enabled or no logsinks had been configured during"]
    #[doc = " connecting, does nothing. This also re-enables the deprecated protocol logging, if it was enabled"]
    #[doc = " at least once using Worker_Connection_SetProtocolLoggingEnabled before."]
    pub fn Worker_Connection_EnableLogging(connection: *mut Worker_Connection);
}
extern "C" {
    #[doc = " Disables all logging. If logging was already disabled or no logsinks had been configured during"]
    #[doc = " connecting, does nothing. This also disables the deprecated protocol logging, if it was enabled"]
    #[doc = " at least once using Worker_Connection_SetProtocolLoggingEnabled before."]
    pub fn Worker_Connection_DisableLogging(connection: *mut Worker_Connection);
}
extern "C" {
...
pub const Worker_SnapshotType_WORKER_SNAPSHOT_TYPE_BINARY: Worker_SnapshotType = 0;
pub const Worker_SnapshotType_WORKER_SNAPSHOT_TYPE_JSON: Worker_SnapshotType = 1;
#[doc = " Snapshot type, used by the Worker_SnapshotParameters struct."]
pub type Worker_SnapshotType = ::std::os::raw::c_int;
#[doc = " Parameters for interacting with a snapshot."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Worker_SnapshotParameters {
    #[doc = " Snapshot type, defined in Worker_SnapshotType"]
    ...
    #[doc = " Default vtable used when a component is not registered. Only used if not NULL."]
    pub default_component_vtable: *const Worker_ComponentVtable,
    #[doc = " Schema bundle. Used only if the snapshot type is a JSON snapshot."]
    pub schema_bundle: *const Schema_Bundle,
    #[doc = " JSON parameters. By default, if json_parameters is not specified, then SnapshotOutputStream"]
    #[doc = " will default to writing JSON in compact form. Used only if the snapshot type is a JSON"]
    #[doc = " snapshot."]
    pub json_parameters: *const Schema_JsonParameters,
}
...
pub type Worker_StreamState = ::std::os::raw::c_int;
#[doc = " Struct to keep track of the state of snapshot streams."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Worker_SnapshotState {
    #[doc = " Stream state."]
    pub stream_state: u8,
    #[doc = " Error message. NULL if not set."]
...
extern "C" {
    ...
    #[doc = " returned Worker_SnapshotInputStream* by calling Worker_SnapshotInputStream_Destroy to"]
    ...
    #[doc = " Calling Worker_SnapshotInputStream_GetState with this pointer will return"]
    ...
    #[doc = " Worker_SnapshotInputStream_Destroy."]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " If an error occurs, or the stream has reached the end of the file, then this function will return"]
    #[doc = " a null pointer."]
    #[doc = ""]
    #[doc = " In the case that a null pointer is returned, you must call Worker_SnapshotInputStream_GetState"]
    #[doc = " to get the details of what error occurred during the operation."]
...
extern "C" {
    ...
    #[doc = " Calling Worker_SnapshotOutputStream_GetState with this pointer will return"]
    #[doc = " an error message describing any error that occured. In the event of an error, the caller still"]
...
extern "C" {
    #[doc = " Writes next entity_id, entity pair from input. Must call Worker_SnapshotOutputStream_GetState"]
    #[doc = " after this function to check whether any error occurred during operation."]
...
extern "C" {
    #[doc = " Returns the last warning message generated by a call to Worker_SnapshotOutputStream_WriteEntity."]
    #[doc = " Will return NULL if no warning was generated."]
    pub fn Worker_SnapshotOutputStream_GetLastWarning(
        output_stream: *mut Worker_SnapshotOutputStream,
    ) -> *const ::std::os::raw::c_char;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Ngrpc_Client {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Ngrpc_Call {
    _unused: [u8; 0],
}
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_OK: Ngrpc_StatusCode = 0;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_CANCELLED: Ngrpc_StatusCode = 1;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_UNKNOWN: Ngrpc_StatusCode = 2;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_INVALID_ARGUMENT: Ngrpc_StatusCode = 3;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_DEADLINE_EXCEEDED: Ngrpc_StatusCode = 4;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_NOT_FOUND: Ngrpc_StatusCode = 5;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_ALREADY_EXISTS: Ngrpc_StatusCode = 6;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_PERMISSION_DENIED: Ngrpc_StatusCode = 7;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_RESOURCE_EXHAUSTED: Ngrpc_StatusCode = 8;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_FAILED_PRECONDITION: Ngrpc_StatusCode = 9;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_ABORTED: Ngrpc_StatusCode = 10;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_OUT_OF_RANGE: Ngrpc_StatusCode = 11;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_UNIMPLEMENTED: Ngrpc_StatusCode = 12;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_INTERNAL: Ngrpc_StatusCode = 13;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_UNAVAILABLE: Ngrpc_StatusCode = 14;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_DATA_LOSS: Ngrpc_StatusCode = 15;
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_UNAUTHENTICATED: Ngrpc_StatusCode = 16;
#[doc = " An internal error of this gRPC client implementation."]
pub const Ngrpc_StatusCode_NGRPC_STATUS_CODE_NGRPC_CLIENT_ERROR: Ngrpc_StatusCode = 100;
#[doc = " gRPC status code. Mirrors https://github.com/grpc/grpc/blob/master/doc/statuscodes.md."]
pub type Ngrpc_StatusCode = ::std::os::raw::c_int;
#[doc = " Parameters to create an Ngrpc_Client."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Ngrpc_Parameters {
    #[doc = " The connection timeout in milliseconds. Use 0 for no timeout."]
    pub connect_timeout_ms: u64,
    #[doc = " Whether to use a secure connection (TLS)."]
    pub use_tls: u8,
    #[doc = " Parameters for TLS. Ignored if `use_tls` is not set."]
    pub tls_params: *mut Ngrpc_TlsParameters,
}
impl Default for Ngrpc_Parameters {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[doc = " Transport Layer Security (TLS) parameters. Ngrpc_Client does not attempt to use the platform-"]
#[doc = " specific root certificate store of the current machine. Instead, one or more root certificates"]
#[doc = " must be provided as part of the connection parameters."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Ngrpc_TlsParameters {
    #[doc = " Number of root certificates."]
    pub root_certificate_count: u32,
    #[doc = " Pointer to root certificates in PEM format."]
    pub root_certificates: *const *const ::std::os::raw::c_char,
}
impl Default for Ngrpc_TlsParameters {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[doc = " A gRPC status code and message. Used as the result of initial connection and individual calls."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Ngrpc_Status {
    #[doc = " The gRPC status code."]
    pub code: Ngrpc_StatusCode,
    #[doc = " The status message. Always non-NULL, but can be empty."]
    pub message: *const ::std::os::raw::c_char,
}
impl Default for Ngrpc_Status {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[doc = " Parameters to create an Ngrpc_Call."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Ngrpc_CallParameters {
    #[doc = " Timeout for the entire call in milliseconds. Use 0 for no timeout."]
    pub timeout_ms: u64,
    #[doc = " Number of metadata key-value pairs to attach to the call."]
    pub metadata_count: u32,
    #[doc = " Pointer to metadata key-value pairs."]
    pub metadata: *const Ngrpc_CallMetadata,
}
impl Default for Ngrpc_CallParameters {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[doc = " Metadata key-value pairs to attach to a gRPC call."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Ngrpc_CallMetadata {
    #[doc = " Key string. Must be unique, lower case, and not clash with a standard HTTP/2 header name."]
    pub key: *const ::std::os::raw::c_char,
    #[doc = " Value string."]
    pub value: *const ::std::os::raw::c_char,
}
impl Default for Ngrpc_CallMetadata {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[doc = " A pointer to a block of binary data and its length."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Ngrpc_Buffer {
    #[doc = " Pointer to the data. Can be NULL to indicate an end-of-stream or error condition."]
    pub buffer: *const u8,
    #[doc = " Length of the data."]
    pub length: u32,
}
impl Default for Ngrpc_Buffer {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
extern "C" {
    #[doc = " Creates an Ngrpc_Client which can be used to make calls to the specified gRPC server. Always"]
    #[doc = " returns a valid (non-NULL) pointer - use Ngrpc_GetStatus to check if creation was actually"]
    #[doc = " successful. All operations on an Ngrpc_Client and any of its associated Ngrpc_Calls are not"]
    #[doc = " thread-safe, so must not be performed concurrently. Use Ngrpc_Destroy to free resources when"]
    #[doc = " finished."]
    pub fn Ngrpc_Create(
        hostname: *const ::std::os::raw::c_char,
        port: u16,
        params: *const Ngrpc_Parameters,
    ) -> *mut Ngrpc_Client;
}
extern "C" {
    #[doc = " Returns the status of the Ngrpc_Client object. This will have code NGRPC_STATUS_CODE_OK if"]
    #[doc = " initial creation was successful, otherwise it will describe the error that occurred. The return"]
    #[doc = " value is the same throughout the lifetime of the Ngrpc_Client object. The returned status message"]
    #[doc = " string is only valid up until Ngrpc_Destroy is called on the Ngrpc_Client object."]
    pub fn Ngrpc_GetStatus(client: *mut Ngrpc_Client) -> Ngrpc_Status;
}
extern "C" {
    #[doc = " Destroys (frees the resources associated with) the given Ngrpc_Client. Any active Ngrpc_Call"]
    #[doc = " objects associated with the Ngrpc_Client are also destroyed."]
    pub fn Ngrpc_Destroy(client: *mut Ngrpc_Client);
}
extern "C" {
    #[doc = " Creates a gRPC call object for making a single call. Always returns a valid (non-NULL) pointer."]
    #[doc = " Use Ngrpc_DestroyCall (or Ngrpc_Destroy) to free resources when finished."]
    pub fn Ngrpc_MakeCall(
        client: *mut Ngrpc_Client,
        method_path: *const ::std::os::raw::c_char,
        params: *const Ngrpc_CallParameters,
    ) -> *mut Ngrpc_Call;
}
extern "C" {
    #[doc = " Sends the request portion of a gRPC call. Currently only supported once per Ngrpc_Call (no"]
    #[doc = " streaming). This function blocks until the send has completed (or an error or timeout occurs)."]
    #[doc = " Return value is 0 for failure, 1 for success. Retrieve error information using Ngrpc_FinishCall."]
    pub fn Ngrpc_Send(call: *mut Ngrpc_Call, buffer: *const u8, length: u32) -> u8;
}
extern "C" {
    #[doc = " Receives the response portion of a gRPC call. This function blocks until a response is received"]
    #[doc = " (or an error or timeout occurs). The pointer in the returned Ngrpc_Buffer will be NULL if"]
    #[doc = " end-of-stream was reached or an error occurred. After such a NULL value, all future calls to"]
    #[doc = " Ngrpc_Receive with the same Ngrpc_Call object will also return NULL. As streaming responses are"]
    #[doc = " not currently supported, the second call will always return NULL. Retrieve error information"]
    #[doc = " using Ngrpc_FinishCall (NGRPC_STATUS_CODE_OK indicating that end-of-stream occurred rather than"]
    #[doc = " an actual error). The returned buffer is only valid until the next Ngrpc_Receive or"]
    #[doc = " Ngrpc_FinishCall operation on the Ngrpc_Call object."]
    pub fn Ngrpc_Receive(call: *mut Ngrpc_Call) -> Ngrpc_Buffer;
}
extern "C" {
    #[doc = " Finishes a gRPC call, returning the call status information. Can only be called once per"]
    #[doc = " Ngrpc_Call object, and no operation other than Ngrpc_DestroyCall can be performed on the"]
    #[doc = " Ngrpc_Call object subsequently. The returned status message string is only valid up until"]
    #[doc = " Ngrpc_DestroyCall is called on the Ngrpc_Call object."]
    pub fn Ngrpc_FinishCall(call: *mut Ngrpc_Call) -> Ngrpc_Status;
}
extern "C" {
    #[doc = " Destroys (frees the resources associated with) the given Ngrpc_Call."]
    pub fn Ngrpc_DestroyCall(call: *mut Ngrpc_Call);
}
extern "C" {
    #[doc = " Converts a gRPC status code into string form, for example, for inclusion in log messages. The"]
    #[doc = " returned string is always non-NULL, but can be empty in case of an unknown status code. The"]
    #[doc = " returned string is valid indefinitely."]
    pub fn Ngrpc_StatusCodeToString(status: Ngrpc_StatusCode) -> *const ::std::os::raw::c_char;
}
extern "C" {
    #[doc = " Returns Improbable's TLS root certificate in PEM format. Populate Ngrpc_TlsParameters with this"]
    #[doc = " value to use Platform SDK services. The returned string is valid indefinitely."]
    pub fn Ngrpc_GetImprobableRootCertificate() -> *const ::std::os::raw::c_char;
}
