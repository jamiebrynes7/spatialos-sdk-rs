...
impl ComponentData<Example> for generated::example::Example {
    fn merge(&mut self, update: generated::example::ExampleUpdate) {
...
impl ComponentUpdate<Example> for generated::example::ExampleUpdate {
    fn merge(&mut self, update: generated::example::ExampleUpdate) {
    ...
    fn serialize_command_request(request: &generated::example::ExampleCommandRequest) -> Result<schema::SchemaCommandRequest, String> {
        ...
        match request {
            ExampleCommandRequest::test_command(ref data) => {
                TypeSerializer::<generated::example::CommandData>::serialize(data, serialized_request.object_mut());
            },
            _ => unreachable!()
        }
        ...
        match request.command_index() {
            1 => {
                Some(ExampleCommandRequest::test_command(
                    TypeSerializer::<generated::example::CommandData>::deserialize(request.object())
                ))
            },
    ...
    fn serialize_command_response(response: &generated::example::ExampleCommandResponse) -> Result<schema::SchemaCommandResponse, String> {
        ...
        match response {
            ExampleCommandResponse::test_command(ref data) => {
                TypeSerializer::<generated::example::CommandData>::serialize(data, serialized_response.object_mut())
            },
            _ => unreachable!()
        }
        ...
        match response.command_index() {
            1 => {
                Some(ExampleCommandResponse::test_command(
                    TypeSerializer::<generated::example::CommandData>::deserialize(response.object());
                ))
            },
...
pub struct ComponentInterest {
    queries: Vec<generated::improbable::ComponentInterest::Query>,
}
impl TypeSerializer<ComponentInterest> for ComponentInterest {
    fn serialize(input: &Self, output: &mut schema::SchemaObject) -> Result<(), String> {
        for element in &input.queries.iter() { TypeSerializer::<generated::improbable::ComponentInterest::Query>::serialize(element, &mut output.field::<SchemaObject>(1).add()); };
        Ok(())
    }
    fn deserialize(input: &schema::SchemaObject) -> Result<Self, String> {
        Ok(Self {
            queries: { let size = input.field::<SchemaObject>(1).count(); let mut l = Vec::with_capacity(size); for i in 0..size { l.push(TypeSerializer::<generated::improbable::ComponentInterest::Query>::deserialize(input.field::<SchemaObject>(1).index(i))); }; l },
        })
    }
}
...
impl ComponentData<EntityAcl> for generated::improbable::EntityAcl {
    fn merge(&mut self, update: generated::improbable::EntityAclUpdate) {
...
impl TypeSerializer<EntityAclUpdate> for EntityAclUpdate {
    fn serialize(input: &Self, output: &mut schema::SchemaObject) -> Result<(), String> {
        if let Some(ref value) = input.read_acl {
            TypeSerializer::<generated::improbable::WorkerRequirementSet>::serialize(value, &mut output.field::<SchemaObject>(1).add());
        }
        if let Some(ref value) = input.component_write_acl {
            for (k, v) in value { let object = output.field::<SchemaObject>(2).add(); object.field::<u32>(1).add(k); TypeSerializer::<generated::improbable::WorkerRequirementSet>::serialize(v, &mut object.field::<SchemaObject>(2).add()); };
        }
        Ok(())
    }
    fn deserialize(input: &schema::SchemaObject) -> Result<Self, String> {
        ...
        if _field_read_acl.count() > 0 {
            ...
            output.read_acl = TypeSerializer::<generated::improbable::WorkerRequirementSet>::deserialize(field.get_or_default());
        }
        ...
        if _field_component_write_acl.count() > 0 {
            ...
            output.component_write_acl = { let size = field.count(); let mut m = BTreeMap::new(); for i in 0..size { let kv = field.index(i); m.insert(kv.field::<SchemaObject>(1), TypeSerializer::<generated::improbable::WorkerRequirementSet>::deserialize(kv.field::<SchemaObject>(2))); }; m };
        }
        Ok(output)
    }
}
impl ComponentUpdate<EntityAcl> for generated::improbable::EntityAclUpdate {
    fn merge(&mut self, update: generated::improbable::EntityAclUpdate) {
...
impl ComponentData<Interest> for generated::improbable::Interest {
    fn merge(&mut self, update: generated::improbable::InterestUpdate) {
...
impl TypeSerializer<InterestUpdate> for InterestUpdate {
    fn serialize(input: &Self, output: &mut schema::SchemaObject) -> Result<(), String> {
        if let Some(ref value) = input.component_interest {
            for (k, v) in value { let object = output.field::<SchemaObject>(1).add(); object.field::<u32>(1).add(k); TypeSerializer::<generated::improbable::ComponentInterest>::serialize(v, &mut object.field::<SchemaObject>(2).add()); };
        }
        Ok(())
    }
    fn deserialize(input: &schema::SchemaObject) -> Result<Self, String> {
        ...
        if _field_component_interest.count() > 0 {
            ...
            output.component_interest = { let size = field.count(); let mut m = BTreeMap::new(); for i in 0..size { let kv = field.index(i); m.insert(kv.field::<SchemaObject>(1), TypeSerializer::<generated::improbable::ComponentInterest>::deserialize(kv.field::<SchemaObject>(2))); }; m };
        }
        Ok(output)
    }
}
impl ComponentUpdate<Interest> for generated::improbable::InterestUpdate {
    fn merge(&mut self, update: generated::improbable::InterestUpdate) {
...
impl ComponentData<Metadata> for generated::improbable::Metadata {
    fn merge(&mut self, update: generated::improbable::MetadataUpdate) {
...
impl ComponentUpdate<Metadata> for generated::improbable::MetadataUpdate {
    fn merge(&mut self, update: generated::improbable::MetadataUpdate) {
...
impl ComponentData<Persistence> for generated::improbable::Persistence {
    fn merge(&mut self, update: generated::improbable::PersistenceUpdate) {
    }
}
...
impl ComponentUpdate<Persistence> for generated::improbable::PersistenceUpdate {
    fn merge(&mut self, update: generated::improbable::PersistenceUpdate) {
    }
}
...
impl ComponentData<Position> for generated::improbable::Position {
    fn merge(&mut self, update: generated::improbable::PositionUpdate) {
...
impl TypeSerializer<PositionUpdate> for PositionUpdate {
    fn serialize(input: &Self, output: &mut schema::SchemaObject) -> Result<(), String> {
        if let Some(ref value) = input.coords {
            TypeSerializer::<generated::improbable::Coordinates>::serialize(value, &mut output.field::<SchemaObject>(1).add());
        }
        Ok(())
    }
    fn deserialize(input: &schema::SchemaObject) -> Result<Self, String> {
        ...
        if _field_coords.count() > 0 {
            ...
            output.coords = TypeSerializer::<generated::improbable::Coordinates>::deserialize(field.get_or_default());
        }
        Ok(output)
    }
}
impl ComponentUpdate<Position> for generated::improbable::PositionUpdate {
    fn merge(&mut self, update: generated::improbable::PositionUpdate) {
...
#[derive(Debug)]
pub struct Query {
    constraint: generated::improbable::ComponentInterest::QueryConstraint,
...
impl TypeSerializer<Query> for Query {
    fn serialize(input: &Self, output: &mut schema::SchemaObject) -> Result<(), String> {
        TypeSerializer::<generated::improbable::ComponentInterest::QueryConstraint>::serialize(&input.constraint, &mut output.field::<SchemaObject>(1).add());
    ...
    fn deserialize(input: &schema::SchemaObject) -> Result<Self, String> {
        Ok(Self {
            constraint: TypeSerializer::<generated::improbable::ComponentInterest::QueryConstraint>::deserialize(input.field::<SchemaObject>(1).get_or_default()),
...
pub struct QueryConstraint {
    sphere_constraint: Option<generated::improbable::ComponentInterest::SphereConstraint>,
    cylinder_constraint: Option<generated::improbable::ComponentInterest::CylinderConstraint>,
    box_constraint: Option<generated::improbable::ComponentInterest::BoxConstraint>,
    relative_sphere_constraint: Option<generated::improbable::ComponentInterest::RelativeSphereConstraint>,
    relative_cylinder_constraint: Option<generated::improbable::ComponentInterest::RelativeCylinderConstraint>,
    relative_box_constraint: Option<generated::improbable::ComponentInterest::RelativeBoxConstraint>,
    entity_id_constraint: Option<i64>,
    component_constraint: Option<u32>,
    and_constraint: Vec<generated::improbable::ComponentInterest::QueryConstraint>,
    or_constraint: Vec<generated::improbable::ComponentInterest::QueryConstraint>,
}
impl TypeSerializer<QueryConstraint> for QueryConstraint {
    fn serialize(input: &Self, output: &mut schema::SchemaObject) -> Result<(), String> {
        TypeSerializer::<generated::improbable::ComponentInterest::SphereConstraint>::serialize(&input.sphere_constraint, &mut output.field::<SchemaObject>(1).add());
        TypeSerializer::<generated::improbable::ComponentInterest::CylinderConstraint>::serialize(&input.cylinder_constraint, &mut output.field::<SchemaObject>(2).add());
        TypeSerializer::<generated::improbable::ComponentInterest::BoxConstraint>::serialize(&input.box_constraint, &mut output.field::<SchemaObject>(3).add());
        TypeSerializer::<generated::improbable::ComponentInterest::RelativeSphereConstraint>::serialize(&input.relative_sphere_constraint, &mut output.field::<SchemaObject>(4).add());
        TypeSerializer::<generated::improbable::ComponentInterest::RelativeCylinderConstraint>::serialize(&input.relative_cylinder_constraint, &mut output.field::<SchemaObject>(5).add());
        TypeSerializer::<generated::improbable::ComponentInterest::RelativeBoxConstraint>::serialize(&input.relative_box_constraint, &mut output.field::<SchemaObject>(6).add());
        output.field::<i64>(7).add(&input.entity_id_constraint);
        output.field::<u32>(8).add(&input.component_constraint);
        for element in &input.and_constraint.iter() { TypeSerializer::<generated::improbable::ComponentInterest::QueryConstraint>::serialize(element, &mut output.field::<SchemaObject>(9).add()); };
        for element in &input.or_constraint.iter() { TypeSerializer::<generated::improbable::ComponentInterest::QueryConstraint>::serialize(element, &mut output.field::<SchemaObject>(10).add()); };
        Ok(())
    }
    fn deserialize(input: &schema::SchemaObject) -> Result<Self, String> {
        Ok(Self {
            sphere_constraint: input.field::<SchemaObject>(1).get().map(|v| { TypeSerializer::<generated::improbable::ComponentInterest::SphereConstraint>::deserialize(v) }),
            cylinder_constraint: input.field::<SchemaObject>(2).get().map(|v| { TypeSerializer::<generated::improbable::ComponentInterest::CylinderConstraint>::deserialize(v) }),
            box_constraint: input.field::<SchemaObject>(3).get().map(|v| { TypeSerializer::<generated::improbable::ComponentInterest::BoxConstraint>::deserialize(v) }),
            relative_sphere_constraint: input.field::<SchemaObject>(4).get().map(|v| { TypeSerializer::<generated::improbable::ComponentInterest::RelativeSphereConstraint>::deserialize(v) }),
            relative_cylinder_constraint: input.field::<SchemaObject>(5).get().map(|v| { TypeSerializer::<generated::improbable::ComponentInterest::RelativeCylinderConstraint>::deserialize(v) }),
            relative_box_constraint: input.field::<SchemaObject>(6).get().map(|v| { TypeSerializer::<generated::improbable::ComponentInterest::RelativeBoxConstraint>::deserialize(v) }),
            entity_id_constraint: input.field::<i64>(7).get().map(|v| { v }),
            component_constraint: input.field::<u32>(8).get().map(|v| { v }),
            and_constraint: { let size = input.field::<SchemaObject>(9).count(); let mut l = Vec::with_capacity(size); for i in 0..size { l.push(TypeSerializer::<generated::improbable::ComponentInterest::QueryConstraint>::deserialize(input.field::<SchemaObject>(9).index(i))); }; l },
            or_constraint: { let size = input.field::<SchemaObject>(10).count(); let mut l = Vec::with_capacity(size); for i in 0..size { l.push(TypeSerializer::<generated::improbable::ComponentInterest::QueryConstraint>::deserialize(input.field::<SchemaObject>(10).index(i))); }; l },
        })
    }
}
